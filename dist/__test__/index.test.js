...
var executeAllTests = function (Country, State, City) {
    ...
    test('Check for Country By undefined Code ', function () {
        var code;
        var country = Country.getCountryByCode();
        expect(country).toEqual(code);
    });
    test('Check for Canada States', function () {
        var code = 'CA';
        var country = Country.getCountryByCode(code);
        var states = State.getStatesOfCountry(country.isoCode);
    ...
    test('Check States for undefined code', function () {
        var code;
        var states = State.getStatesOfCountry(code);
    ...
    test('Check Cities for Delhi', function () {
        ...
        var names = cities.map(function (city) {
            return city.name;
        });
        expect(names).toEqual([
            'Alipur',
    ...
    test('Check Cities for undefined State', function () {
        var countryCode;
        var stateCode = 'DL';
        var cities = City.getCitiesOfState(countryCode, stateCode);
    ...
    test('Get State by State ISOCode and Country Code', function () {
        var countryCode = 'PK';
        var stateCode = 'KP';
        var state = State.getStateByCodeAndCountry(stateCode, countryCode);
        expect(state.name).toEqual('Khyber Pakhtunkhwa');
    });
    test('Get State by State ISOCode undefined and Country Code', function () {
        var countryCode = 'PK';
        var stateCode;
        var state = State.getStateByCodeAndCountry(stateCode, countryCode);
        expect(state).toEqual(undefined);
    });
    test('Get State by State and Country Code undefined', function () {
        var countryCode;
        var stateCode = 'KP';
        var state = State.getStateByCodeAndCountry(stateCode, countryCode);
        expect(state).toEqual(undefined);
...
executeAllTests(index_1.Country, index_1.State, index_1.City);
